...
The program consists of a GUI where the user selects the tracking star and has the option to start and end the guiding, additionally it also has simple camera controls: exposure and gain. The results are shown below and as can be seen the stars stay round when taking long exposure pictures (5min):
